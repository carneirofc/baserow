...
our [git repository](https://github.com/carneirofc/baserow/tree/master/deploy/nginx/).
...
> * Or our `docker-compose.no-caddy.yml` example file in our [git repository](https://github.com/carneirofc/baserow/tree/master/deploy/nginx/).
> 
...
> the [deploy/nginx/recommended](https://github.com/carneirofc/baserow/tree/master/deploy/nginx/)
> folder.
...
> You can find a Dockerized working example of using Nginx with Baserow in our git repo in
> the [deploy/nginx/no-caddy](https://github.com/carneirofc/baserow/tree/master/deploy/nginx/)
> folder.
