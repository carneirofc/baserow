...
We strongly recommend you use our `baserow/baserow:2.3.2` image or the example
`docker-compose.yml` files (excluding the `.no-caddy.yml` variant) provided in
our [git repository](https://github.com/carneirofc/baserow/tree/master/deploy/apache/).
...
>
> * Your own container setup with our single service `baserow/backend:2.3.2`
    and `baserow/web-frontend:2.3.2` images.
> * Or our `docker-compose.no-caddy.yml` example file in our [git repository](https://github.com/carneirofc/baserow/tree/master/deploy/apache/).
> 
...
> the [deploy/apache/recommended](https://github.com/carneirofc/baserow/tree/master/deploy/apache/)
> folder.

Follow this option if you are using:

* The all-in-one Baserow image `baserow/baserow:2.3.2`
...
> You can find a Dockerized working example of using Apache with Baserow in our git repo in
> the [deploy/apache/no-caddy](https://github.com/carneirofc/baserow/tree/master/deploy/apache/)
> folder.

Follow this option if you are using:

* Our standalone `baserow/backend:2.3.2` and `baserow/web-frontend:2.3.2` images with
...
If you are using the `baserow/backend:2.3.2` image then you can do this by adding
