...
- Workspace admins add existing users directly (`workspace.add_workspace_users`, candidate search needs at least 3 characters and never lists deactivated or to-be-deleted accounts), manage teams (`core/teams/`) and grants; staff manage grants of any workspace.
