...
const envMapping = {
  ...
  EXPORT_FILE_EXPIRE_MINUTES: 'NUXT_PUBLIC_EXPORT_FILE_EXPIRE_MINUTES',
  BASEROW_SNAPSHOT_EXPIRATION_TIME_DAYS:
    'NUXT_PUBLIC_BASEROW_SNAPSHOT_EXPIRATION_TIME_DAYS',
  BASEROW_USER_LOG_ENTRY_RETENTION_DAYS:
    'NUXT_PUBLIC_BASEROW_USER_LOG_ENTRY_RETENTION_DAYS',
  BASEROW_ROW_HISTORY_RETENTION_DAYS:
    'NUXT_PUBLIC_BASEROW_ROW_HISTORY_RETENTION_DAYS',
